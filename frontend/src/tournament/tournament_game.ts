...
export class Pong {
    ...
    constructor (
        ...
        this.initialize(gridSize, paddleHeight, paddleSpeed, ballSpeed, winScore, leftPlayerName, rightPlayerName);
    }
    ...
    private initialize(
        gridSize: number, paddleHeight: number, paddleSpeed: number, ballSpeed: number, winScore: number,
        ...
        this._rightPaddle = new Paddle (
            rightPlayerName, gridSize, paddleHeight,
            this._sidebarWidth + this._gameWidth - gridSize * 2, this._canvasHeight / 2 - paddleHeight / 2
        );
    ...
    private gameLoop = (): void => {
        ...
        else if (ball.getY() + gridSize > gHeight - gridSize) {
